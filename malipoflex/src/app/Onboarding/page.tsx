...
export default function Getstarted() {
  ...
  return (
    <div className="max-w-full min-h-screen bg-[#075D74] flex items-center justify-center relative ovrerflow-x-hidden">
      <div className="w-full max-w-[2200px] flex flex-row items-center justify-between px-24 py-20">
        ...
        <div className="absolute w-1/2 flex items-center justify-center z-10">
          <Image
            src="/images/man.png"
            alt="MalipoFlex Hero"
            className="max-w-full h-auto ml-300 pointer-events-none "
            width={785}
            height={550}
          />
        </div>
